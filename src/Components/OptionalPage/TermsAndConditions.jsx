...
const TermsAndConditions = () => {
  ...
  <p>
    Welcome to Luxurious Hotel. These terms and conditions outline the rules and regulations for the use of our website and our services. By accessing this website and using our services, you accept these terms and conditions in full.
  </p>
  <p>
  ...
  <p>
    Other than the content you own, under these terms, Luxurious Hotel and/or its licensors own all the intellectual property rights and materials contained on this website.
  </p>
  <h3 className="text-xl font-semibold mt-4">Contact Information</h3>
  <p>
    If you have any questions or concerns regarding these terms and conditions, please contact us at{' '}
    <a href="mailto:info@luxurioushotel.com" className="text-orange-500 hover:underline">
